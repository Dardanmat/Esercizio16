...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        //metodo che stampa in dettaglio il viaggio e le caratteristiche di ogni singolo giorno del viaggio.
//        System.out.println("\nStampa del viaggio num.4 (Francia e Spagna):\n"); 
//        v4.stampaCompletaViaggio();
        
//        System.out.println("\nViaggio più costoso: " + agenzia.viaggioPiuCostoso());
//        System.out.println("\nViaggio più costoso per singoli: " + agenzia.viaggioSingoliPiuCostoso().toString());
//        System.out.println("\nViaggio più costoso per gruppi: " + agenzia.viaggioGruppiPiuCostoso().toString());
        
        
//        System.out.println("\nLista Viaggi con un che hanno un giorno in Albania\n");
//        for(Viaggio v: agenzia.listaViaggiConGiorno(g1)){
